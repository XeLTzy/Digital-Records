...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/pdf-style.css') }}" type="text/css" media="all" />
</head>
                    ...
                    <tbody>
                        <tr>
                            <td class="w-full align-top">
                                <div>
                                    <img src="{{ asset('assets\images\logo-v5.png') }}" class="h-12" />
                                </div>
                            </td>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="border-r pr-4">
                                                    <div>
                                                        <p class="whitespace-nowrap text-slate-400 text-right">Date Issue</p>
        ...
        <p class="italic">Lorem ipsum is placeholder text commonly used in the graphic, print, and publishing industries
          for previewing layouts and visual mockups.</p>
            ...
            <footer class="fixed bottom-0 left-0 bg-slate-100 w-full text-neutral-600 text-center text-xs py-3">
                Dentista Royale Dental Works
                <span class="text-slate-300 px-2">|</span>
                no-reply@dentistaroyale.com
                <span class="text-slate-300 px-2">|</span>
                09178391624
            </footer>
        </div>
